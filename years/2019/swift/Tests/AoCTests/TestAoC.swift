...
class TestAoC: XCTestCase {
  ...
  func testDay7() async throws {
    ...
    // XCTAssertEqual(p1, 1_501_149)
    // XCTAssertEqual(p2, 10_096_985)
  }
  ...
  func testDay11() async throws {
    ...
    // XCTAssertEqual(p2, 25_590_400_731)
  }
  ...
  func testDay15() async throws {
    ...
    XCTAssertEqual(p1, 5_181_556)
    XCTAssertEqual(p2, 12_817_603_219_131)
  }
  */
  ...
  */
  ...
  func testDay21() async throws {
    ...
    // XCTAssertEqual(p1, 10_037_517_593_724)
    // XCTAssertEqual(p2, 3_272_260_914_328)
  }
